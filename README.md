...
# 2. Listar registros
curl -H "Authorization: Bearer $TOKEN" http://localhost:8080/api/fornecedors
...
|----------|---------|---------|
| `/api/fornecedors` | GET / POST / PUT / DELETE | CRUD de Fornecedor |
| `/api/contratos` | GET / POST / PUT / DELETE | CRUD de Contrato |
| `/api/medicaos` | GET / POST / PUT / DELETE | CRUD de Medicao |
| `/api/aditivos` | GET / POST / PUT / DELETE | CRUD de Aditivo |
